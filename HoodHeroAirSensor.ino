 ...
 */
 ...
 // LED display = Adafruit_SSD1306

 
#include <DFRobot_ENS160.h> //Air Sensor Library 
...
void loop()
{
   ...
   // Clear the buffer (update with each measurement)
  display.clearDisplay();
  display.display();
 ...
 // OLED outputs 
  ...
  delay(60000); //time delay for sensor readings in milliseconds 
}
